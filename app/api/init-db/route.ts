 ...
 * 数据库初始化 API
 * 一次性运行来填充初始数据
 * 访问 /api/init-db?secret=YOUR_SECRET 来初始化
 */
...
export async function GET(request: Request) {
  try {
    ...
    // 10. 创建网站内容配置
    console.log('⚙️ 创建网站内容配置...')
    const siteContents = [
      // 统计数据
      { section: 'stats', key: 'stat1_label', value: '社群成员', type: 'text', description: '统计项1标题' },
      { section: 'stats', key: 'stat1_value', value: '5,000+', type: 'text', description: '统计项1数值' },
      { section: 'stats', key: 'stat1_note', value: '覆盖高校 / 大厂 / 创业者', type: 'text', description: '统计项1说明' },
      { section: 'stats', key: 'stat2_label', value: '技术 Talk', type: 'text', description: '统计项2标题' },
      { section: 'stats', key: 'stat2_value', value: '300+', type: 'text', description: '统计项2数值' },
      { section: 'stats', key: 'stat2_note', value: '深度分享与论文精读', type: 'text', description: '统计项2说明' },
      { section: 'stats', key: 'stat3_label', value: '项目共创', type: 'text', description: '统计项3标题' },
      { section: 'stats', key: 'stat3_value', value: '150+', type: 'text', description: '统计项3数值' },
      { section: 'stats', key: 'stat3_note', value: 'Agent 与多模态落地案例', type: 'text', description: '统计项3说明' },
