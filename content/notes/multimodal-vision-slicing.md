...
title: "图片问答答非所问，问题可能不在模型而在视觉切片"
excerpt: "小字、表格和长截图经常不是模型能力不够，而是它根本没有以合适的分辨率看到目标。用全图定位、局部切片、OCR 和证据合并，才能把视觉问答做稳。"
series: "多模态"
seriesNo: "08"
number: "35"
minutes: 25
...
用户上传一张 3000 像素宽的合同截图，问“第二页违约金是多少”。模型回答“未约定”。工程师换了更大的模型，答案还是错。打开视觉输入日志才发现，系统把整张图片压成了 768 像素，违约金那一行只剩下几根模糊的横线。
