...
excerpt: "离线集测的是固定样本，线上面对的却是会变的用户、工具和数据。分布漂移、长尾失败、版本组合、副作用不进评测，就解释不了“离线 95%，线上 70%”的落差。"
series: "评测"
seriesNo: "09"
number: "41"
minutes: 20
...
```yaml
counterfactual_replay: cfr_3e376b
