...
title: "面试官让你从零设计企业知识库 Agent，先画哪张图"
excerpt: "企业知识库 Agent 的第一张图不是模型调用图，而是证据和权限图：谁在什么租户里，能检索哪些版本，答案如何引用，失败后怎样追溯。"
series: "项目深挖"
seriesNo: "11"
number: "50"
minutes: 27
...
很多人马上画出 `用户 → LLM → 向量库 → 答案`。这张图能说明你知道 RAG，却没有说明企业系统最在意的三件事：答案凭什么可信、不同员工为什么看到不同内容、资料更新后旧答案如何失效。
