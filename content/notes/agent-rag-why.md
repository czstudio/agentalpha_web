...
excerpt: "RAG 不是大模型项目的默认装饰。要不要用，取决于知识是否变化、是否需要引用、数据是否私有，以及检索成本能不能抵过上下文和维护成本。"
series: "项目深挖"
seriesNo: "11"
number: "51"
minutes: 26
...
如果回答只是“因为模型有幻觉”，追问很快就来了：提示词不能解决吗？微调不行吗？知识量不大为什么还要向量库？检索错了怎么办？
