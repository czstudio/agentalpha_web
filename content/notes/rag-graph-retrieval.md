...
excerpt: "问题跨文档、跨实体、需要多跳关系时，图结构能补上纯向量相似度的短板。设计时要同时记录节点、边、来源、时间和路径评分，不能只做一张好看的关系网。"
series: "RAG"
seriesNo: "03"
number: "67"
minutes: 23
...
“这家公司在 2024 年收购的团队后来用了哪个模型？”不是找一段最相似的文字就能答稳的。系统得沿着公司—事件—团队—时间—模型几层关系走，而且每条边都能回到原文。Graph RAG 难的不是把图画出来，而是让路径变成可审计证据。
