...
title: "多 Agent 不是群聊：角色分工、消息协议和状态同步怎么做"
excerpt: "让多个 Agent 协作的关键不是让它们互相发消息，而是约定谁能说什么、谁能改什么、状态何时提交，以及一条消息如何被确认。"
series: "多智能体"
seriesNo: "07"
number: "30"
minutes: 20
...
“你问一下研究 Agent”“好的，我觉得可以交给分析 Agent”——如果多 Agent 的通信长这样，它本质上还是群聊。消息很多，责任很少；状态在每个上下文里各存一份，最后谁也说不清哪份是最新的。
