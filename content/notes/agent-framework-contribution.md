...
excerpt: "框架解决的是通用编排，你的贡献应该落在具体约束下的决策、证据和结果：为什么这样设计、验证过什么、失败后怎样改，而不是罗列用了哪些组件。"
series: "项目深挖"
seriesNo: "11"
number: "54"
minutes: 22
...
这句话并不一定是在否定项目。面试官想知道的是：如果把框架换掉，哪些能力仍然属于你？你解决的是哪条业务约束？你做过什么实验，结果怎样？
...
如果只讲第一层，换一个框架项目就消失了；如果能讲清第二、三层，面试官才能看到你的工程判断。
