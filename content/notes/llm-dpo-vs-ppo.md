---
slug: "llm-dpo-vs-ppo"
title: "DPO 和 PPO 到底差在哪？什么时候不需要单独训练奖励模型"
excerpt: "DPO 把偏好优化改写成一个离线分类目标，省掉了 PPO 的在线 rollout 和显式奖励模型，但它并没有消除数据质量、参考策略和分布外风险。把目标函数、训练链路和选型边界放在一起，才能真正回答 DPO 与 PPO 的差异。"
series: "LLM 训练"
seriesNo: "05"
number: "21"
minutes: 19
