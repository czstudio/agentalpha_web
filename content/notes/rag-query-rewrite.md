...
title: "RAG 查询改写不是把问题说长：先守住原意，再扩大可检索性"
excerpt: "Query rewrite、拆解和假设文档的价值，是把用户表达映射到知识库的语言，而不是让模型自由发挥新问题。每一次改写都要能回指原问、记录版本并可被否决。"
series: "RAG"
seriesNo: "03"
number: "66"
minutes: 21
...
用户问“这个政策今年还能报吗”，知识库里可能写的是“2026 年差旅费用报销条件”。如果直接拿原句检索，召回不稳定；如果让模型随意改写，又可能偷偷加上“员工级别”“城市”和“金额”等原问题没有的限制。好的 query rewrite 是受约束的翻译，不是替用户补脑。
